  ...
  return (
    <section className="highlights" aria-labelledby="highlights-title">
      <div className="section-head">
        ...
        <p>Superbinary turns the typing moment into a simple flow: see the suggestion, accept the next word, keep writing.</p>
      </div>
      ...
      <div className="sticky-frame">
        <div className="stage">
          ...
          <div className="caption">
            ...
            <p>Context around the cursor helps Superbinary offer words that match the moment, without sending completion to the cloud.</p>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="apps" aria-labelledby="apps-title">
      <div className="section-head">
        ...
        <p>Messages, notes, docs, email, browser fields, and project tools. One autocomplete behavior across your Mac.</p>
      </div>
      <AppMarquee />
      <p className="app-note">App names are illustrative of normal writing surfaces, not partnerships or official integrations.</p>
    </section>
  );
}
        ...
        <div className="privacy-board">
          <div className="privacy-demo">
            <div className="privacy-lock" aria-hidden="true">
              <LockKeyhole size={52} strokeWidth={1.7} />
            </div>
            <p className="eyebrow">Privacy</p>
            <h2 id="privacy-title">Private by default.</h2>
            <p>Completion happens on your Mac. The model ships with the app. Your private text is not used for training.</p>
  ...
  return (
    <footer className="site-footer" aria-label="Site information">
      <div className="footer-inner">
        <p className="footer-note">Superbinary is an independent Mac app for private, system-wide writing autocomplete.</p>
        ...
        <nav className="footer-links" aria-label="Footer links">
          ...
          <a href="mailto:hello@superbinary.app">Contact</a>
        </nav>
      </div>
    </footer>
  );
